...
def save_train_test_data(positive_pickle, negative_pickle, save_path_prefix):
    ...
    # save test data
    save_data_dict = dict()
    save_data_dict["X_test"] = np.array(X_test_ccs)
    save_data_dict["y_test"] = np.array(y_test_ccs)

    save_data_dict["test_subread_counts"] = np.array(test_subread_counts_ccs)
    save_data_dict["test_final_ccss"] = np.array(test_final_ccss_ccs)
    save_data_dict["test_final_strands"] = np.array(test_final_strands_ccs)
    save_data_dict["test_final_m6a_call_positions"] = np.array(test_final_m6a_call_positions_ccs)
