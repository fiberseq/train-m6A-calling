...
```{r}
ft1=fread("~/Desktop/unaligned.fiberseq.tbl.gz", nrows = 10000) %>% select(-fiber_sequence)
```
...
```{r}
ft2 = read_m6a("~/Desktop/temp/tmp.tbl.gz")
```
...
#dist_df = dist_df %>% filter(fiber %in% fibers)
```
