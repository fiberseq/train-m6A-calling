...
def save_train_test_data(positive_pickle, negative_pickle, save_path_prefix):
    ...
    save_data_dict['train_final_m6a_call_positions'] = np.array(train_final_m6a_call_positions_ccs)
    save_data_dict['val_final_m6a_call_positions'] = np.array(val_final_m6a_call_positions_ccs)
